    ...
    <section className="py-12 px-4 bg-gray-100">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Dr. Olumayowa Abimbola Oninla Card */}
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
            <img 
              src={olumayowaOninla} 
              alt="Dr. Olumayowa Abimbola Oninla" 
              className="w-full h-48 object-contain rounded-t-lg mb-4"
            />
          ...
          {/* Dr Nkiruka Pauline Onodugo Card */}
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
            <img 
              src={nkirukaOnodugo} 
              alt="Dr Nkiruka Pauline Onodugo" 
              className="w-full h-48 object-contain rounded-t-lg mb-4"
            />
          ...
          {/* Dr Ogunbor Omokhaye Excel Card */}
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
            <img 
              src={ogunborExcel} 
              alt="Dr Ogunbor Omokhaye Excel" 
              className="w-full h-48 object-contain rounded-t-lg mb-4"
            />
